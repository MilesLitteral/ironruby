...
StdLib
  ...
  - Modern stdlib sets are available under Languages\Ruby\StdLib\ruby:
    - 3.4.0 (from MRI 3.4.9)
    - 4.0.0 (from MRI 4.0.1)
  - To build with Ruby 4 defaults, define the compilation symbol RUBY40_STDLIB.
